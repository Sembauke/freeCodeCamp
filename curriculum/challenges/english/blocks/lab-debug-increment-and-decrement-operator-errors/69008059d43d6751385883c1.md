...
Your `updatedCounter` variable should equal `11`.
...
Your `finalScore` variable should equal `8`.
...
Your `updatedCoins` variable should equal `2`.
...
Your `newHealth` variable should equal `7`.
