...
Finally, JavaScript makes your webpage interactive. It lets you tell the page what to do when someone clicks a button, submits a form, and much more.

For the last step of the workshop, add another `h3` element and another `p` element to the page, describing JavaScript.
...
Your `p` element's text should be `JavaScript adds interactivity to a webpage`. You can copy the text from the instructions.
