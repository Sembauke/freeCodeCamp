...
Your `firstResult` variable should have the numeric value `15`.
...
Your `secondResult` variable should have the numeric value `3`.
...
Your `thirdResult` variable should not include a boolean value (`true` or `false`).
...
Your `thirdResult` variable should have the numeric value `6`.
...
Your `fourthResult` variable should not include a boolean value (`true` or `false`).
...
Your `fourthResult` variable should have the numeric value `8`.
...
Your `fifthResult` variable should not include a string multiplication (e.g. "10" * 2).
...
Your `fifthResult` variable should have the numeric value `20`.
...
Your `sixthResult` variable should not include `null` in its expression.
...
Your `sixthResult` variable should have the numeric value `22`.
